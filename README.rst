...
Line #     Duration    Increment   Line Contents
================================================
     4     0.0000 s     45.8 MiB   @profile
     5                             def my_func():
     6     0.0002 s      0.0 MiB       print("get in ")
     7                             
     8     0.0001 s      0.0 MiB       print("tel me why")
     9     0.0001 s      0.0 MiB       return "hallo"
